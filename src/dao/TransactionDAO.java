...
public class TransactionDAO {
    ...
    public boolean createTransaction(Transaction transaction) {
        String sql = "INSERT INTO Transaction (account_number, transaction_type, amount, description) VALUES (?, ?, ?, ?)";
    ...
    public List<Transaction> getTransactionsByType(String accountNumber, String transactionType) {
        List<Transaction> transactions = new ArrayList<>();
        String sql = "SELECT * FROM Transaction WHERE account_number = ? AND transaction_type = ? ORDER BY transaction_date DESC";
